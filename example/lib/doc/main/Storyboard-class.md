...
[Storyboard](../main/Storyboard/Storyboard.md) ({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
##### [build](../main/Storyboard/build.md)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)



Describes the part of the user interface represented by this widget. [...](../main/Storyboard/build.md)  
_override_
